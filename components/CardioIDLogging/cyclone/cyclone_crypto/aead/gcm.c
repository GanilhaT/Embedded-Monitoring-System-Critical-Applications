...
__weak_func error_list gcmInit(GcmContext *context, const CipherAlgo *cipherAlgo,
   void *cipherContext)
{
   uint_t i;
   uint_t j;
...
__weak_func error_list gcmEncrypt(GcmContext *context, const uint8_t *iv,
...
__weak_func error_list gcmDecrypt(GcmContext *context, const uint8_t *iv,
