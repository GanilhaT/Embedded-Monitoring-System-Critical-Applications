...
error_list blowfishInit(BlowfishContext *context, const uint8_t *key,
   size_t keyLen);

error_list blowfishInitState(BlowfishContext *context);

error_list blowfishExpandKey(BlowfishContext *context, const uint8_t *salt,
