...
error_list xtsInit(XtsContext *context, const CipherAlgo *cipherAlgo,
   const void *key, size_t keyLen);

error_list xtsEncrypt(XtsContext *context, const uint8_t *i, const uint8_t *p,
   uint8_t *c, size_t length);

error_list xtsDecrypt(XtsContext *context, const uint8_t *i, const uint8_t *c,
