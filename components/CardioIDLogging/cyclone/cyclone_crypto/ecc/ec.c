...
error_list ecLoadDomainParameters(EcDomainParameters *params,
...
__weak_func error_list ecGenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
error_list ecGeneratePrivateKey(const PrngAlgo *prngAlgo, void *prngContext,
   const EcDomainParameters *params, EcPrivateKey *privateKey)
{
   error_list error;
...
error_list ecGeneratePublicKey(const EcDomainParameters *params,
...
error_list ecCopy(EcPoint *r, const EcPoint *s)
{
   error_list error;
...
error_list ecImport(const EcDomainParameters *params, EcPoint *r,
...
error_list ecExport(const EcDomainParameters *params, const EcPoint *a,
...
error_list ecProjectify(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s)
{
   error_list error;
...
__weak_func error_list ecAffinify(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s)
{
   error_list error;
   Mpi a;
...
error_list ecDouble(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s)
{
   error_list error;
   Mpi t1;
...
error_list ecAdd(const EcDomainParameters *params, EcPoint *r,
...
error_list ecFullAdd(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s, const EcPoint *t)
{
   error_list error;
...
error_list ecFullSub(const EcDomainParameters *params, EcPoint *r,
   const EcPoint *s, const EcPoint *t)
{
   error_list error;
   EcPoint u;
...
__weak_func error_list ecMult(const EcDomainParameters *params, EcPoint *r, const Mpi *d,
   const EcPoint *s)
{
   error_list error;
   uint_t i;
...
error_list ecTwinMult(const EcDomainParameters *params, EcPoint *r,
...
error_list ecAddMod(const EcDomainParameters *params, Mpi *r, const Mpi *a,
   const Mpi *b)
{
   error_list error;
...
error_list ecSubMod(const EcDomainParameters *params, Mpi *r, const Mpi *a,
   const Mpi *b)
{
   error_list error;
...
__weak_func error_list ecMulMod(const EcDomainParameters *params, Mpi *r, const Mpi *a,
   const Mpi *b)
{
   error_list error;
...
__weak_func error_list ecSqrMod(const EcDomainParameters *params, Mpi *r, const Mpi *a)
{
   error_list error;
