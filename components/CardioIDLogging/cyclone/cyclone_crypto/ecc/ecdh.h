...
error_list ecdhGenerateKeyPair(EcdhContext *context, const PrngAlgo *prngAlgo,
   void *prngContext);

error_list ecdhCheckPublicKey(const EcDomainParameters *params, EcPoint *publicKey);

error_list ecdhComputeSharedSecret(EcdhContext *context,
