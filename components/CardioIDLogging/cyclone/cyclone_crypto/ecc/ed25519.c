...
error_list ed25519GenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
error_list ed25519GeneratePrivateKey(const PrngAlgo *prngAlgo, void *prngContext,
   uint8_t *privateKey)
{
   error_list error;
...
error_list ed25519GeneratePublicKey(const uint8_t *privateKey, uint8_t *publicKey)
{
   uint8_t *s;
   Ed25519State *state;
...
error_list ed25519GenerateSignature(const uint8_t *privateKey,
...
error_list ed25519GenerateSignatureEx(const uint8_t *privateKey,
...
error_list ed25519VerifySignature(const uint8_t *publicKey, const void *message,
...
error_list ed25519VerifySignatureEx(const uint8_t *publicKey,
