...
error_list eddsaGenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
error_list eddsaGeneratePrivateKey(const PrngAlgo *prngAlgo, void *prngContext,
   const EcCurveInfo *curveInfo, EddsaPrivateKey *privateKey)
{
   error_list error;
...
error_list eddsaGeneratePublicKey(const EcCurveInfo *curveInfo,
