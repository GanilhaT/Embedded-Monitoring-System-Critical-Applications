...
error_list oidCheck(const uint8_t *oid, size_t oidLen);
...
error_list oidEncodeSubIdentifier(uint8_t *oid, size_t maxOidLen,
   size_t *pos, uint32_t value);

error_list oidDecodeSubIdentifier(const uint8_t *oid, size_t oidLen,
   size_t *pos, uint32_t *value);

error_list oidFromString(const char_t *str, uint8_t *oid, size_t maxOidLen,
   size_t *oidLen);

char_t *oidToString(const uint8_t *oid, size_t oidLen, char_t *str,
   size_t maxStrLen);

error_list maskFromString(const char_t *str, uint8_t *mask, size_t maxMaskLen,
   size_t *maskLen);
