...
error_list aesInit(AesContext *context, const uint8_t *key, size_t keyLen)
{
   //Check parameters
...
error_list ecbEncrypt(const CipherAlgo *cipher, void *context,
...
error_list ecbDecrypt(const CipherAlgo *cipher, void *context,
...
error_list cbcEncrypt(const CipherAlgo *cipher, void *context,
...
error_list cbcDecrypt(const CipherAlgo *cipher, void *context,
...
error_list cfbEncrypt(const CipherAlgo *cipher, void *context, uint_t s,
   uint8_t *iv, const uint8_t *p, uint8_t *c, size_t length)
{
   error_list error;
...
error_list cfbDecrypt(const CipherAlgo *cipher, void *context, uint_t s,
   uint8_t *iv, const uint8_t *c, uint8_t *p, size_t length)
{
   error_list error;
...
error_list ofbEncrypt(const CipherAlgo *cipher, void *context, uint_t s,
   uint8_t *iv, const uint8_t *p, uint8_t *c, size_t length)
{
   error_list error;
...
error_list ctrEncrypt(const CipherAlgo *cipher, void *context, uint_t m,
