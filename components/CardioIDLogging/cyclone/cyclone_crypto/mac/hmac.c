...
__weak_func error_list hmacCompute(const HashAlgo *hash, const void *key, size_t keyLen,
...
__weak_func error_list hmacInit(HmacContext *context, const HashAlgo *hash,
