...
error_list mpiSetValue(Mpi *r, int_t a)
{
   error_list error;
...
__weak_func error_list mpiCheckProbablePrime(const Mpi *a)
{
...
__weak_func error_list mpiMul(Mpi *r, const Mpi *a, const Mpi *b)
{
   error_list error;
   int_t i;
   int_t m;
...
__weak_func error_list mpiMulMod(Mpi *r, const Mpi *a, const Mpi *b, const Mpi *p)
{
   error_list error;
...
__weak_func error_list mpiInvMod(Mpi *r, const Mpi *a, const Mpi *p)
{
   error_list error;
   Mpi b;
   Mpi c;
...
__weak_func error_list mpiExpMod(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p)
{
   error_list error;
   int_t i;
   int_t j;
...
__weak_func error_list mpiExpModFast(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p)
{
...
__weak_func error_list mpiExpModRegular(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p)
{
   //Perform modular exponentiation
   return mpiExpMod(r, a, e, p);
}
