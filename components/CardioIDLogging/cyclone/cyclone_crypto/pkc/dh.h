...
error_list dhGenerateKeyPair(DhContext *context, const PrngAlgo *prngAlgo,
   void *prngContext);

error_list dhCheckPublicKey(DhParameters *params, const Mpi *publicKey);

error_list dhComputeSharedSecret(DhContext *context, uint8_t *output,
