...
error_list rsaesPkcs1v15Encrypt(const PrngAlgo *prngAlgo, void *prngContext,
...
error_list rsaesPkcs1v15Decrypt(const RsaPrivateKey *key,
   ...
   size_t messageSize, size_t *messageLen)
{
   ...
   do
   {
      ...
      *messageLen = CRYPTO_SELECT_32(n, messageSize, badLength);
      ...
      error = (error_list) CRYPTO_SELECT_32(error, ERROR_BUFFER_OVERFLOW, badLength);
      error = (error_list) CRYPTO_SELECT_32(error, ERROR_DECRYPTION_FAILED, badPadding);
...
error_list rsaesOaepEncrypt(const PrngAlgo *prngAlgo, void *prngContext,
...
error_list rsaesOaepDecrypt(const RsaPrivateKey *key, const HashAlgo *hash,
...
error_list rsassaPkcs1v15Sign(const RsaPrivateKey *key, const HashAlgo *hash,
...
error_list rsassaPkcs1v15Verify(const RsaPublicKey *key, const HashAlgo *hash,
...
error_list rsassaPssSign(const PrngAlgo *prngAlgo, void *prngContext,
...
error_list rsassaPssVerify(const RsaPublicKey *key, const HashAlgo *hash,
...
__weak_func error_list rsaep(const RsaPublicKey *key, const Mpi *m, Mpi *c)
{
...
__weak_func error_list rsadp(const RsaPrivateKey *key, const Mpi *c, Mpi *m)
{
   error_list error;
   Mpi m1;
   Mpi m2;
...
error_list rsasp1(const RsaPrivateKey *key, const Mpi *m, Mpi *s)
{
...
error_list rsavp1(const RsaPublicKey *key, const Mpi *s, Mpi *m)
{
...
error_list emePkcs1v15Encode(const PrngAlgo *prngAlgo, void *prngContext,
...
error_list emeOaepEncode(const PrngAlgo *prngAlgo, void *prngContext,
...
error_list emsaPkcs1v15Encode(const HashAlgo *hash,
...
error_list emsaPkcs1v15Verify(const HashAlgo *hash, const uint8_t *digest,
...
error_list emsaPssEncode(const PrngAlgo *prngAlgo, void *prngContext,
...
error_list emsaPssVerify(const HashAlgo *hash, size_t saltLen,
...
error_list rsaGenerateKeyPair(const PrngAlgo *prngAlgo, void *prngContext,
...
__weak_func error_list rsaGeneratePrivateKey(const PrngAlgo *prngAlgo, void *prngContext,
...
error_list rsaGeneratePublicKey(const RsaPrivateKey *privateKey,
   RsaPublicKey *publicKey)
{
   error_list error;
