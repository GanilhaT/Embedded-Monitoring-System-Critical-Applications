...
error_list rsaep(const RsaPublicKey *key, const Mpi *m, Mpi *c);
error_list rsadp(const RsaPrivateKey *key, const Mpi *c, Mpi *m);
...
error_list rsaGeneratePrivateKey(const PrngAlgo *prngAlgo, void *prngContext,
