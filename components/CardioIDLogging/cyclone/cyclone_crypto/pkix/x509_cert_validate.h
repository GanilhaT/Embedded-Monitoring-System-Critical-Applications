...
error_list x509ValidateCertificate(const X509CertificateInfo *certInfo,
   const X509CertificateInfo *issuerCertInfo, uint_t pathLen);

error_list x509CheckSubjectName(const X509CertificateInfo *certInfo,
   const char_t *fqdn);

error_list x509CheckNameConstraints(const char_t *subjectName,
