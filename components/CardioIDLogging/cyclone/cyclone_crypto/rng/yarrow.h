...
error_list yarrowInit(YarrowContext *context);

error_list yarrowSeed(YarrowContext *context, const uint8_t *input, size_t length);

error_list yarrowAddEntropy(YarrowContext *context, uint_t source,
   const uint8_t *input, size_t length, size_t entropy);

error_list yarrowRead(YarrowContext *context, uint8_t *output, size_t length);
