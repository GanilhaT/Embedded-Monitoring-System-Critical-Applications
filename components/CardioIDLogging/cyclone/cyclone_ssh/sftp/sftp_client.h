...
typedef error_list (*SftpClientSshInitCallback)(SftpClientContext *context,
...
error_list sftpClientInit(SftpClientContext *context);

error_list sftpClientRegisterSshInitCallback(SftpClientContext *context,
   SftpClientSshInitCallback callback);

error_list sftpClientSetTimeout(SftpClientContext *context, systime_t timeout);

error_list sftpClientBindToInterface(SftpClientContext *context,
   NetInterface *interface);

error_list sftpClientConnect(SftpClientContext *context,
   const IpAddr *serverIpAddr, uint16_t serverPort);

const char_t *sftpClientGetWorkingDir(SftpClientContext *context);

error_list sftpClientChangeWorkingDir(SftpClientContext *context,
   const char_t *path);

error_list sftpClientChangeToParentDir(SftpClientContext *context);

error_list sftpClientOpenDir(SftpClientContext *context, const char_t *path);
error_list sftpClientReadDir(SftpClientContext *context, SftpDirEntry *dirEntry);
error_list sftpClientCloseDir(SftpClientContext *context);

error_list sftpClientCreateDir(SftpClientContext *context, const char_t *path);
error_list sftpClientDeleteDir(SftpClientContext *context, const char_t *path);

error_list sftpClientOpenFile(SftpClientContext *context, const char_t *path,
   uint_t mode);

error_list sftpClientWriteFile(SftpClientContext *context, const void *data,
   size_t length, size_t *written, uint_t flags);

error_list sftpClientReadFile(SftpClientContext *context, void *data, size_t size,
   size_t *received, uint_t flags);

error_list sftpClientCloseFile(SftpClientContext *context);

error_list sftpClientRenameFile(SftpClientContext *context, const char_t *oldPath,
   const char_t *newPath);

error_list sftpClientDeleteFile(SftpClientContext *context, const char_t *path);

SftpStatusCode sftpClientGetStatusCode(SftpClientContext *context);

error_list sftpClientDisconnect(SftpClientContext *context);
error_list sftpClientClose(SftpClientContext *context);
