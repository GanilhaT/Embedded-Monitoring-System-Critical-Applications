...
error_list sftpFormatName(SftpVersion version, const SftpName *name,
   uint8_t *p, size_t *written);

error_list sftpFormatLongFilename(const SshString *filename,
   const SftpFileAttrs *attributes, char_t *p, size_t *written);

error_list sftpFormatAttributes(SftpVersion version,
   const SftpFileAttrs *attributes, uint8_t *p, size_t *written);

error_list sftpParseName(SftpVersion version, SftpName *name, const uint8_t *data,
   size_t length, size_t *consumed);

error_list sftpParseAttributes(SftpVersion version, SftpFileAttrs *attributes,
