...
typedef error_list (*SshHostKeyVerifyCallback)(SshConnection *connection,
...
typedef error_list (*SshCertVerifyCallback)(SshConnection *connection,
...
typedef error_list (*SshCaPublicKeyVerifyCallback)(SshConnection *connection,
...
typedef error_list (*SshPublicKeyAuthCallback)(SshConnection *connection,
...
typedef error_list (*SshCertAuthCallback)(SshConnection *connection,
...
typedef error_list (*SshSignGenCallback)(SshConnection *connection,
...
typedef error_list (*SshSignVerifyCallback)(SshConnection *connection,
...
typedef error_list (*SshEcdhKeyPairGenCallback)(SshConnection *connection,
...
typedef error_list (*SshEcdhSharedSecretCalcCallback)(SshConnection *connection,
...
typedef error_list (*SshGlobalReqCallback)(SshConnection *connection,
...
typedef error_list (*SshChannelReqCallback)(SshChannel *channel,
...
typedef error_list (*SshChannelOpenCallback)(SshConnection *connection,
...
typedef error_list (*SshConnectionOpenCallback)(SshConnection *connection,
   void *param);
...
error_list sshInit(SshContext *context, SshConnection *connections,
   uint_t numConnections, SshChannel *channels, uint_t numChannels);

error_list sshSetOperationMode(SshContext *context, SshOperationMode mode);

error_list sshSetPrng(SshContext *context, const PrngAlgo *prngAlgo,
   void *prngContext);

error_list sshSetUsername(SshContext *context, const char_t *username);
error_list sshSetPassword(SshContext *context, const char_t *password);

error_list sshRegisterHostKeyVerifyCallback(SshContext *context,
   SshHostKeyVerifyCallback callback);

error_list sshRegisterCertVerifyCallback(SshContext *context,
   SshCertVerifyCallback callback);

error_list sshRegisterCaPublicKeyVerifyCallback(SshContext *context,
   SshCaPublicKeyVerifyCallback callback);

error_list sshRegisterPublicKeyAuthCallback(SshContext *context,
   SshPublicKeyAuthCallback callback);

error_list sshRegisterCertAuthCallback(SshContext *context,
   SshCertAuthCallback callback);

error_list sshRegisterPasswordAuthCallback(SshContext *context,
   SshPasswordAuthCallback callback);

error_list sshRegisterPasswordChangeCallback(SshContext *context,
   SshPasswordChangeCallback callback);

error_list sshRegisterSignGenCallback(SshContext *context,
   SshSignGenCallback callback);

error_list sshRegisterSignVerifyCallback(SshContext *context,
   SshSignVerifyCallback callback);

error_list sshRegisterEcdhKeyPairGenCallback(SshContext *context,
   SshEcdhKeyPairGenCallback callback);

error_list sshRegisterEcdhSharedSecretCalcCallback(SshContext *context,
   SshEcdhSharedSecretCalcCallback callback);

error_list sshRegisterGlobalRequestCallback(SshContext *context,
   SshGlobalReqCallback callback, void *param);

error_list sshUnregisterGlobalRequestCallback(SshContext *context,
   SshGlobalReqCallback callback);

error_list sshRegisterChannelRequestCallback(SshContext *context,
   SshChannelReqCallback callback, void *param);

error_list sshUnregisterChannelRequestCallback(SshContext *context,
   SshChannelReqCallback callback);

error_list sshRegisterChannelOpenCallback(SshContext *context,
   SshChannelOpenCallback callback, void *param);

error_list sshUnregisterChannelOpenCallback(SshContext *context,
   SshChannelOpenCallback callback);

error_list sshRegisterConnectionOpenCallback(SshContext *context,
   SshConnectionOpenCallback callback, void *param);

error_list sshUnregisterConnectionOpenCallback(SshContext *context,
   SshConnectionOpenCallback callback);

error_list sshRegisterConnectionCloseCallback(SshContext *context,
   SshConnectionCloseCallback callback, void *param);

error_list sshUnregisterConnectionCloseCallback(SshContext *context,
   SshConnectionCloseCallback callback);

error_list sshLoadRsaKey(SshContext *context, uint_t index,
   const char_t *publicKey, size_t publicKeyLen, const char_t *privateKey,
   size_t privateKeyLen, const char_t *password);

error_list sshUnloadRsaKey(SshContext *context, uint_t index);

error_list sshLoadDhGexGroup(SshContext *context, uint_t index,
   const char_t *dhParams, size_t dhParamsLen);

error_list sshUnloadDhGexGroup(SshContext *context, uint_t index);

error_list sshLoadHostKey(SshContext *context, uint_t index,
   const char_t *publicKey, size_t publicKeyLen, const char_t *privateKey,
   size_t privateKeyLen, const char_t *password);

error_list sshUnloadHostKey(SshContext *context, uint_t index);

error_list sshLoadCertificate(SshContext *context, uint_t index,
   const char_t *cert, size_t certLen, const char_t *privateKey,
   size_t privateKeyLen, const char_t *password);

error_list sshUnloadCertificate(SshContext *context, uint_t index);

error_list sshSetPasswordChangePrompt(SshConnection *connection,
   const char_t *prompt);

SshChannel *sshCreateChannel(SshConnection *connection);

error_list sshSetChannelTimeout(SshChannel *channel, systime_t timeout);

error_list sshWriteChannel(SshChannel *channel, const void *data, size_t length,
   size_t *written, uint_t flags);

error_list sshReadChannel(SshChannel *channel, void *data, size_t size,
   size_t *received, uint_t flags);

error_list sshPollChannels(SshChannelEventDesc *eventDesc, uint_t size,
   OsEvent *extEvent, systime_t timeout);

error_list sshCloseChannel(SshChannel *channel);
