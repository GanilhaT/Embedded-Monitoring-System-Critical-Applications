...
error_list sshFormatKexAlgoList(SshConnection *connection, uint8_t *p,
   size_t *written);

error_list sshFormatHostKeyAlgoList(SshContext *context, uint8_t *p,
   size_t *written);

error_list sshFormatEncAlgoList(SshContext *context, uint8_t *p, size_t *written);
error_list sshFormatMacAlgoList(SshContext *context, uint8_t *p, size_t *written);

error_list sshFormatCompressionAlgoList(SshContext *context, uint8_t *p,
   size_t *written);

error_list sshFormatPublicKeyAlgoList(SshContext *context, uint8_t *p,
   size_t *written);
