...
error_list sshImportCertificate(const char_t *input, size_t inputLen,
...
error_list sshImportRsaCertPublicKey(const SshCertificate *cert,
...
error_list sshImportDsaCertPublicKey(const SshCertificate *cert,
...
error_list sshImportEcdsaCertPublicKey(const SshCertificate *cert,
...
error_list sshImportEd25519CertPublicKey(const SshCertificate *cert,
