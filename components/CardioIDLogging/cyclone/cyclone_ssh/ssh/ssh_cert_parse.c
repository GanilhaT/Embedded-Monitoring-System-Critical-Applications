...
error_list sshParseCertificate(const uint8_t *data, size_t length,
   SshCertificate *cert)
{
   error_list error;
   size_t n;
...
error_list sshParseRsaCertPublicKey(const uint8_t *data, size_t length,
...
error_list sshParseDsaCertPublicKey(const uint8_t *data, size_t length,
...
error_list sshParseEcdsaCertPublicKey(const uint8_t *data, size_t length,
...
error_list sshParseEd25519CertPublicKey(const uint8_t *data, size_t length,
...
error_list sshParseValidPrincipals(const uint8_t *data, size_t length,
...
error_list sshParseCriticalOptions(const uint8_t *data, size_t length,
...
error_list sshParseExtensions(const uint8_t *data, size_t length,
