...
error_list sshVerifyClientCertificate(SshConnection *connection,
...
error_list sshVerifyServerCertificate(SshConnection *connection,
   const SshString *publicKeyAlgo, const SshBinaryString *hostKey)
{
   error_list error;
   SshCertificate cert;
...
error_list sshVerifyPrincipal(const SshCertificate *cert, const char_t *name)
{
   error_list error;
   uint_t i;
   SshString principal;
...
error_list sshVerifyValidity(const SshCertificate *cert)
{
   error_list error;
...
error_list sshVerifyCriticalOptions(SshConnection *connection,
...
error_list sshVerifySrcAddrOption(SshConnection *connection,
...
error_list sshVerifyCertSignature(SshConnection *connection,
   const SshCertificate *cert)
{
   error_list error;
