...
error_list sshSendKexInit(SshConnection *connection)
{
   error_list error;
   size_t length;
   uint8_t *message;
...
error_list sshSendNewKeys(SshConnection *connection)
{
   error_list error;
   uint8_t x;
   size_t length;
...
error_list sshFormatKexInit(SshConnection *connection, uint8_t *p,
   size_t *length)
{
   error_list error;
   size_t n;
...
error_list sshFormatNewKeys(SshConnection *connection, uint8_t *p,
   size_t *length)
{
...
error_list sshParseKexInit(SshConnection *connection, const uint8_t *message,
   size_t length)
{
   error_list error;
   size_t n;
...
error_list sshParseNewKeys(SshConnection *connection, const uint8_t *message,
   size_t length)
{
   error_list error;
   uint8_t x;
...
error_list sshParseKexMessage(SshConnection *connection, uint8_t type,
...
error_list sshDigestClientKexInit(SshConnection *connection)
{
   error_list error;
   size_t n;
   uint8_t *buffer;
