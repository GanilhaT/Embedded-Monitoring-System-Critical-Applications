...
error_list sshSendKexDhGexRequest(SshConnection *connection)
{
...
error_list sshSendKexDhGexGroup(SshConnection *connection)
{
...
error_list sshSendKexDhGexInit(SshConnection *connection)
{
#if (SSH_CLIENT_SUPPORT == ENABLED)
   error_list error;
   size_t length;
...
error_list sshSendKexDhGexReply(SshConnection *connection)
{
#if (SSH_SERVER_SUPPORT == ENABLED)
   error_list error;
   size_t length;
...
error_list sshFormatKexDhGexRequest(SshConnection *connection, uint8_t *p,
   size_t *length)
{
#if (SSH_CLIENT_SUPPORT == ENABLED)
...
error_list sshFormatKexDhGexGroup(SshConnection *connection, uint8_t *p,
   size_t *length)
{
#if (SSH_SERVER_SUPPORT == ENABLED)
   error_list error;
...
error_list sshFormatKexDhGexInit(SshConnection *connection, uint8_t *p,
   size_t *length)
{
#if (SSH_CLIENT_SUPPORT == ENABLED)
   error_list error;
...
error_list sshFormatKexDhGexReply(SshConnection *connection, uint8_t *p,
   size_t *length)
{
#if (SSH_SERVER_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseKexDhGexRequest(SshConnection *connection,
...
error_list sshParseKexDhGexRequestOld(SshConnection *connection,
   const uint8_t *message, size_t length)
{
#if (SSH_SERVER_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseKexDhGexGroup(SshConnection *connection, const uint8_t *message,
   size_t length)
{
#if (SSH_CLIENT_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseKexDhGexInit(SshConnection *connection, const uint8_t *message,
   size_t length)
{
#if (SSH_SERVER_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseKexDhGexReply(SshConnection *connection, const uint8_t *message,
   size_t length)
{
#if (SSH_CLIENT_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseKexDhGexMessage(SshConnection *connection, uint8_t type,
   const uint8_t *message, size_t length)
{
   error_list error;
...
error_list sshComputeDhGexSharedSecret(SshConnection *connection)
{
   error_list error;
...
error_list sshDigestDhGexParams(SshConnection *connection)
{
   error_list error;
   size_t n;
   uint8_t *buffer;
