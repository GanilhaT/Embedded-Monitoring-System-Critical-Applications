...
error_list sshSendKexRsaPubKey(SshConnection *connection)
{
...
error_list sshSendKexRsaSecret(SshConnection *connection,
...
error_list sshSendKexRsaDone(SshConnection *connection)
{
#if (SSH_SERVER_SUPPORT == ENABLED)
   error_list error;
   size_t length;
...
error_list sshFormatKexRsaPubKey(SshConnection *connection, uint8_t *p,
   size_t *length)
{
#if (SSH_SERVER_SUPPORT == ENABLED)
   error_list error;
...
error_list sshFormatKexRsaSecret(SshConnection *connection,
...
error_list sshFormatKexRsaDone(SshConnection *connection, uint8_t *p,
   size_t *length)
{
#if (SSH_SERVER_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseKexRsaPubKey(SshConnection *connection, const uint8_t *message,
   size_t length)
{
#if (SSH_CLIENT_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseKexRsaSecret(SshConnection *connection, const uint8_t *message,
   size_t length)
{
#if (SSH_SERVER_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseKexRsaDone(SshConnection *connection, const uint8_t *message,
   size_t length)
{
#if (SSH_CLIENT_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseKexRsaMessage(SshConnection *connection, uint8_t type,
...
error_list sshFormatTransientRsaPublicKey(SshConnection *connection, uint8_t *p,
   size_t *written)
{
   error_list error;
   int_t i;
...
error_list sshEncryptSharedSecret(SshConnection *connection,
...
error_list sshDecryptSharedSecret(SshConnection *connection,
