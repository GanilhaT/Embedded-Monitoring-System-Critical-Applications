...
error_list sshFormatRsaPublicKey(const RsaPublicKey *publicKey,
...
error_list sshFormatDsaPublicKey(const DsaPublicKey *publicKey,
   uint8_t *p, size_t *written)
{
...
error_list sshFormatEcdsaPublicKey(const EcDomainParameters *params,
...
error_list sshFormatEd25519PublicKey(const EddsaPublicKey *publicKey,
   uint8_t *p, size_t *written)
{
...
error_list sshFormatEd448PublicKey(const EddsaPublicKey *publicKey,
   uint8_t *p, size_t *written)
{
...
error_list sshFormatOpenSshPrivateKeyHeader(uint8_t *p, size_t *written)
{
   error_list error;
   size_t n;
...
error_list sshFormatOpenSshRsaPrivateKey(const RsaPrivateKey *privateKey,
   uint8_t *p, size_t *written)
{
#if (SSH_RSA_SIGN_SUPPORT == ENABLED)
   error_list error;
...
error_list sshFormatOpenSshDsaPrivateKey(const DsaPrivateKey *privateKey,
...
error_list sshFormatOpenSshEcdsaPrivateKey(const EcDomainParameters *params,
...
error_list sshFormatOpenSshEd25519PrivateKey(const EddsaPrivateKey *privateKey,
...
error_list sshFormatOpenSshEd448PrivateKey(const EddsaPrivateKey *privateKey,
   const EddsaPublicKey *publicKey, uint8_t *p, size_t *written)
{
#if (SSH_ED448_SIGN_SUPPORT == ENABLED)
   error_list error;
