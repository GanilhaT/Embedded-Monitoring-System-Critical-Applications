...
error_list sshInitEncryptionEngine(SshConnection *connection,
...
error_list sshSelectCipherAlgo(SshEncryptionEngine *encryptionEngine,
...
error_list sshSelectHashAlgo(SshEncryptionEngine *encryptionEngine,
...
error_list sshDeriveKey(SshConnection *connection, uint8_t x, uint8_t *output,
   size_t outputLen)
{
   error_list error;
   size_t i;
