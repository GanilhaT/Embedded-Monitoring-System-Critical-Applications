...
error_list sshParseHostKey(const uint8_t *data, size_t length,
...
error_list sshParseRsaHostKey(const uint8_t *data, size_t length,
   SshRsaHostKey *hostKey)
{
#if (SSH_RSA_SIGN_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseDsaHostKey(const uint8_t *data, size_t length,
   SshDsaHostKey *hostKey)
{
#if (SSH_DSA_SIGN_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseEcdsaHostKey(const uint8_t *data, size_t length,
   SshEcdsaHostKey *hostKey)
{
#if (SSH_ECDSA_SIGN_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseEd25519HostKey(const uint8_t *data, size_t length,
   SshEddsaHostKey *hostKey)
{
#if (SSH_ED25519_SIGN_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseEd448HostKey(const uint8_t *data, size_t length,
   SshEddsaHostKey *hostKey)
{
#if (SSH_ED448_SIGN_SUPPORT == ENABLED)
   error_list error;
...
error_list sshParseOpenSshPrivateKeyHeader(const uint8_t *data, size_t length,
...
error_list sshParseOpenSshRsaPrivateKey(const uint8_t *data, size_t length,
...
error_list sshParseOpenSshDsaPrivateKey(const uint8_t *data, size_t length,
...
error_list sshParseOpenSshEcdsaPrivateKey(const uint8_t *data, size_t length,
...
error_list sshParseOpenSshEd25519PrivateKey(const uint8_t *data, size_t length,
...
error_list sshParseOpenSshEd448PrivateKey(const uint8_t *data, size_t length,
   SshEddsaPrivateKey *privateKey)
{
#if (SSH_ED448_SIGN_SUPPORT == ENABLED)
   error_list error;
...
error_list sshCheckPrivateKeyPadding(const uint8_t *pad, size_t length)
{
   error_list error;
   size_t i;
