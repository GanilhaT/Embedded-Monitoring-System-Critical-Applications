...
error_list sshProcessConnectionEvents(SshContext *context,
...
error_list sshFormatHostKey(SshConnection *connection, uint8_t *p,
   size_t *written);

const EcCurveInfo *sshGetCurveInfo(const SshString *keyFormatId,
   const SshString *curveName);

error_list sshParseString(const uint8_t *p, size_t length, SshString *string);

error_list sshParseBinaryString(const uint8_t *p, size_t length,
   SshBinaryString *string);

error_list sshParseNameList(const uint8_t *p, size_t length,
...
error_list sshFormatString(const char_t *value, uint8_t *p, size_t *written);

error_list sshFormatBinaryString(const void *value, size_t valueLen, uint8_t *p,
   size_t *written);

error_list sshFormatNameList(const char_t *const nameList[], uint_t nameListLen,
   uint8_t *p, size_t *written);

error_list sshFormatMpint(const Mpi *value, uint8_t *p, size_t *written);

error_list sshConvertArrayToMpint(const uint8_t *value, size_t length, uint8_t *p,
   size_t *written);
