...
error_list ipSendDatagram(NetInterface *interface, IpPseudoHeader *pseudoHeader,
   NetBuffer *buffer, size_t offset, NetTxAncillary *ancillary);

error_list ipSelectSourceAddr(NetInterface **interface,
...
error_list ipJoinMulticastGroup(NetInterface *interface, const IpAddr *groupAddr);
error_list ipLeaveMulticastGroup(NetInterface *interface, const IpAddr *groupAddr);
...
error_list ipStringToAddr(const char_t *str, IpAddr *ipAddr);
