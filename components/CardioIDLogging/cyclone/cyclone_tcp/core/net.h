...
error_list netSeedRand(const uint8_t *seed, size_t length);
...
error_list netSetMacAddr(NetInterface *interface, const MacAddr *macAddr);
error_list netGetMacAddr(NetInterface *interface, MacAddr *macAddr);

error_list netSetEui64(NetInterface *interface, const Eui64 *eui64);
error_list netGetEui64(NetInterface *interface, Eui64 *eui64);

error_list netSetInterfaceId(NetInterface *interface, uint32_t id);
error_list netSetInterfaceName(NetInterface *interface, const char_t *name);
error_list netSetHostname(NetInterface *interface, const char_t *name);

error_list netSetVlanId(NetInterface *interface, uint16_t vlanId);
error_list netSetVmanId(NetInterface *interface, uint16_t vmanId);

error_list netSetParentInterface(NetInterface *interface,
   NetInterface *physicalInterface);

error_list netSetDriver(NetInterface *interface, const NicDriver *driver);

error_list netSetPhyDriver(NetInterface *interface, const PhyDriver *driver);
error_list netSetPhyAddr(NetInterface *interface, uint8_t phyAddr);

error_list netSetSwitchDriver(NetInterface *interface, const SwitchDriver *driver);
error_list netSetSwitchPort(NetInterface *interface, uint8_t port);

error_list netSetSmiDriver(NetInterface *interface, const SmiDriver *driver);
error_list netSetSpiDriver(NetInterface *interface, const SpiDriver *driver);
error_list netSetUartDriver(NetInterface *interface, const UartDriver *driver);
error_list netSetExtIntDriver(NetInterface *interface, const ExtIntDriver *driver);

error_list netSetLinkState(NetInterface *interface, NicLinkState linkState);
...
error_list netEnablePromiscuousMode(NetInterface *interface, bool_t enable);

error_list netConfigInterface(NetInterface *interface);
error_list netStartInterface(NetInterface *interface);
error_list netStopInterface(NetInterface *interface);
