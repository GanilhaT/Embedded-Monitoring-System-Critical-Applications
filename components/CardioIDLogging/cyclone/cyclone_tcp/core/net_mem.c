...
error_list netBufferSetLength(NetBuffer *buffer, size_t length)
{
   uint_t i;
   uint_t chunkCount;
   ChunkDesc *chunk;
...
error_list netBufferConcat(NetBuffer *dest,
...
error_list netBufferCopy(NetBuffer *dest, size_t destOffset,
   const NetBuffer *src, size_t srcOffset, size_t length)
{
   uint_t i;
   uint_t j;
...
error_list netBufferAppend(NetBuffer *dest, const void *src, size_t length)
{
   uint_t i;
