...
typedef error_list (*NicInit)(NetInterface *interface);
...
typedef error_list (*NicSendPacket)(NetInterface *interface,
   const NetBuffer *buffer, size_t offset, NetTxAncillary *ancillary);

typedef error_list (*NicUpdateMacAddrFilter)(NetInterface *interface);
typedef error_list (*NicUpdateMacConfig)(NetInterface *interface);
...
typedef error_list (*PhyInit)(NetInterface *interface);
...
typedef error_list (*SwitchInit)(NetInterface *interface);
...
typedef error_list (*SwitchTagFrame)(NetInterface *interface, NetBuffer *buffer,
   size_t *offset, NetTxAncillary *ancillary);

typedef error_list (*SwitchUntagFrame)(NetInterface *interface, uint8_t **frame,
...
typedef error_list (*SwitchAddFdbEntry)(NetInterface *interface,
   const SwitchFdbEntry *entry);

typedef error_list (*SwitchDeleteFdbEntry)(NetInterface *interface,
   const SwitchFdbEntry *entry);

typedef error_list (*SwitchGetFdbEntry)(NetInterface *interface, uint_t index,
...
typedef error_list (*SmiInit)(void);
...
typedef error_list (*SpiInit)(void);
typedef error_list (*SpiSetMode)(uint_t mode);
typedef error_list (*SpiSetBitrate)(uint_t bitrate);
...
typedef error_list (*UartInit)(void);
...
typedef error_list (*ExtIntInit)(void);
...
error_list nicSendPacket(NetInterface *interface, const NetBuffer *buffer,
   size_t offset, NetTxAncillary *ancillary);

error_list nicUpdateMacAddrFilter(NetInterface *interface);
