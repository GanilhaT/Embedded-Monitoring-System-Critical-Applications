...
error_list ping(NetInterface *interface, const IpAddr *targetIpAddr,
...
error_list pingSetTimeout(PingContext *context, systime_t timeout)
{
   //Invalid context?
   if(context == NULL)
      return ERROR_INVALID_PARAMETER;
...
error_list pingBindToInterface(PingContext *context, NetInterface *interface)
{
   //Invalid context?
   if(context == NULL)
      return ERROR_INVALID_PARAMETER;
...
error_list pingSendRequest(PingContext *context,
...
error_list pingCheckReply(PingContext *context, const IpAddr *srcIpAddr,
...
error_list pingWaitForReply(PingContext *context,
