...
error_list rawSocketProcessIpPacket(NetInterface *interface,
...
error_list rawSocketSendIpPacket(Socket *socket, const SocketMsg *message,
   uint_t flags)
{
   error_list error;
   size_t offset;
...
error_list rawSocketSendEthPacket(Socket *socket, const SocketMsg *message,
   uint_t flags)
{
   error_list error;
...
error_list rawSocketReceiveIpPacket(Socket *socket, SocketMsg *message,
   uint_t flags)
{
   error_list error;
   SocketQueueItem *queueItem;
...
error_list rawSocketReceiveEthPacket(Socket *socket, SocketMsg *message,
   uint_t flags)
{
   error_list error;
   SocketQueueItem *queueItem;
