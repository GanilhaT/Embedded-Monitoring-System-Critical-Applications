...
error_list tcpConnect(Socket *socket, const IpAddr *remoteIpAddr, uint16_t remotePort)
{
   error_list error;
   uint_t event;
...
error_list tcpListen(Socket *socket, uint_t backlog)
{
...
error_list tcpSend(Socket *socket, const uint8_t *data,
...
error_list tcpReceive(Socket *socket, uint8_t *data,
...
error_list tcpShutdown(Socket *socket, uint_t how)
{
   error_list error;
   uint_t event;
...
error_list tcpAbort(Socket *socket)
{
   error_list error;
