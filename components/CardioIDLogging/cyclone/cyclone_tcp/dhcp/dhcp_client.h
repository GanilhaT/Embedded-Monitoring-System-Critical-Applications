...
typedef error_list (*DhcpParseOptionsCallback)(DhcpClientContext *context,
...
error_list dhcpClientInit(DhcpClientContext *context,
   const DhcpClientSettings *settings);

error_list dhcpClientStart(DhcpClientContext *context);
error_list dhcpClientStop(DhcpClientContext *context);

error_list dhcpClientRelease(DhcpClientContext *context);
