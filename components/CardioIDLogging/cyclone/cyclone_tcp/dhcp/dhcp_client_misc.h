...
error_list dhcpClientSendDiscover(DhcpClientContext *context);
error_list dhcpClientSendRequest(DhcpClientContext *context);
error_list dhcpClientSendDecline(DhcpClientContext *context);
error_list dhcpClientSendRelease(DhcpClientContext *context);
