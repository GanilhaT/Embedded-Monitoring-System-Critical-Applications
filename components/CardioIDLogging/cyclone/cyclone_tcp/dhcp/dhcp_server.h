...
error_list dhcpServerInit(DhcpServerContext *context,
   const DhcpServerSettings *settings);

error_list dhcpServerStart(DhcpServerContext *context);
error_list dhcpServerStop(DhcpServerContext *context);
