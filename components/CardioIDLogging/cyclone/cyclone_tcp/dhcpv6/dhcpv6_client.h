...
error_list dhcpv6ClientInit(Dhcpv6ClientContext *context,
   const Dhcpv6ClientSettings *settings);

error_list dhcpv6ClientStart(Dhcpv6ClientContext *context);
error_list dhcpv6ClientStop(Dhcpv6ClientContext *context);

error_list dhcpv6ClientRelease(Dhcpv6ClientContext *context);
