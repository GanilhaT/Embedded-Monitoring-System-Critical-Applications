...
error_list dhcpv6ClientSendMessage(Dhcpv6ClientContext *context,
...
error_list dhcpv6ClientParseIaNaOption(Dhcpv6ClientContext *context,
   const Dhcpv6Option *option);

error_list dhcpv6ClientParseIaAddrOption(Dhcpv6ClientContext *context,
   const Dhcpv6Option *option);
...
error_list dhcpv6ClientGenerateDuid(Dhcpv6ClientContext *context);
error_list dhcpv6ClientGenerateLinkLocalAddr(Dhcpv6ClientContext *context);
