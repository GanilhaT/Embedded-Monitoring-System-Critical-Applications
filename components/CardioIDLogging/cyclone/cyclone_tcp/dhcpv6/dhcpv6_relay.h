...
error_list dhcpv6RelayStart(Dhcpv6RelayContext *context, const Dhcpv6RelaySettings *settings);
error_list dhcpv6RelayStop(Dhcpv6RelayContext *context);

error_list dhcpv6RelayJoinMulticastGroup(Dhcpv6RelayContext *context);
error_list dhcpv6RelayLeaveMulticastGroup(Dhcpv6RelayContext *context);

void dhcpv6RelayTask(void *param);

error_list dhcpv6ForwardClientMessage(Dhcpv6RelayContext *context, uint_t index);
error_list dhcpv6ForwardRelayReplyMessage(Dhcpv6RelayContext *context);
