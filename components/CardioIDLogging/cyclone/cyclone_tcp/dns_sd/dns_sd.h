...
error_list dnsSdInit(DnsSdContext *context, const DnsSdSettings *settings);
error_list dnsSdStart(DnsSdContext *context);
error_list dnsSdStop(DnsSdContext *context);
MdnsState dnsSdGetState(DnsSdContext *context);

error_list dnsSdSetInstanceName(DnsSdContext *context, const char_t *instanceName);

error_list dnsSdRegisterService(DnsSdContext *context, const char_t *serviceName,
   uint16_t priority, uint16_t weight, uint16_t port, const char_t *metadata);

error_list dnsSdUnregisterService(DnsSdContext *context, const char_t *serviceName);

uint_t dnsSdGetNumServices(DnsSdContext *context);
error_list dnsSdStartProbing(DnsSdContext *context);
