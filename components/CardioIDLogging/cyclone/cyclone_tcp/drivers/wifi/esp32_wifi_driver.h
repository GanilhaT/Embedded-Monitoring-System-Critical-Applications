...
error_list esp32WifiInit(NetInterface *interface);
...
error_list esp32WifiSendPacket(NetInterface *interface,
   const NetBuffer *buffer, size_t offset, NetTxAncillary *ancillary);

error_list esp32WifiUpdateMacAddrFilter(NetInterface *interface);
