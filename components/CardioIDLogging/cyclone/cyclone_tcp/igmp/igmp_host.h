...
error_list igmpHostInit(NetInterface *interface);
error_list igmpHostJoinGroup(NetInterface *interface, Ipv4FilterEntry *entry);
error_list igmpHostLeaveGroup(NetInterface *interface, Ipv4FilterEntry *entry);
