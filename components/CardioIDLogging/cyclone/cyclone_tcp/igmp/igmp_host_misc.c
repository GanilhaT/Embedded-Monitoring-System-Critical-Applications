...
error_list igmpHostSendMembershipReport(NetInterface *interface, Ipv4Addr ipAddr)
{
   IgmpMessage message;
...
error_list igmpHostSendLeaveGroup(NetInterface *interface, Ipv4Addr ipAddr)
{
   IgmpMessage message;
   IgmpHostContext *context;
