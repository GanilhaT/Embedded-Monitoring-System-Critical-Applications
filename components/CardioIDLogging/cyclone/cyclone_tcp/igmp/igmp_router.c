...
error_list igmpRouterInit(IgmpRouterContext *context,
...
error_list igmpRouterStart(IgmpRouterContext *context)
{
...
error_list igmpRouterStop(IgmpRouterContext *context)
{
   //Make sure the IGMP router context is valid
   if(context == NULL)
      return ERROR_INVALID_PARAMETER;
