...
error_list igmpRouterSendGeneralQuery(IgmpRouterContext *context)
{
...
error_list igmpRouterSendGroupSpecificQuery(IgmpRouterContext *context,
   Ipv4Addr groupAddr)
{
...
error_list igmpRouterSendMembershipQuery(IgmpRouterContext *context,
