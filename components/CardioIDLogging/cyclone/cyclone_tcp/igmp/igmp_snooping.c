...
error_list igmpSnoopingInit(IgmpSnoopingContext *context,
...
error_list igmpSnoopingStart(IgmpSnoopingContext *context)
{
...
error_list igmpSnoopingStop(IgmpSnoopingContext *context)
{
   uint_t i;
