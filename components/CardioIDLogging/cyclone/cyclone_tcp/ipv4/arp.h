...
error_list arpInit(NetInterface *interface);

error_list arpAddStaticEntry(NetInterface *interface, Ipv4Addr ipAddr,
   const MacAddr *macAddr);

error_list arpRemoveStaticEntry(NetInterface *interface, Ipv4Addr ipAddr);
...
error_list arpResolve(NetInterface *interface, Ipv4Addr ipAddr, MacAddr *macAddr);

error_list arpEnqueuePacket(NetInterface *interface, Ipv4Addr ipAddr,
...
error_list arpSendProbe(NetInterface *interface, Ipv4Addr targetIpAddr);

error_list arpSendRequest(NetInterface *interface, Ipv4Addr targetIpAddr,
   const MacAddr *destMacAddr);

error_list arpSendReply(NetInterface *interface, Ipv4Addr senderIpAddr,
