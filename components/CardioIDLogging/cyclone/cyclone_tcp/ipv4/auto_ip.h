...
error_list autoIpInit(AutoIpContext *context, const AutoIpSettings *settings);

error_list autoIpStart(AutoIpContext *context);
error_list autoIpStop(AutoIpContext *context);
