...
error_list icmpEnableEchoRequest(NetInterface *interface, bool_t enable);
error_list icmpEnableBroadcastEchoRequest(NetInterface *interface, bool_t enable);
...
error_list icmpSendErrorMessage(NetInterface *interface, uint8_t type, uint8_t code,
