...
error_list ipv4Init(NetInterface *interface)
{
   Ipv4Context *context;
...
error_list ipv4SetHostAddr(NetInterface *interface, Ipv4Addr addr)
{
...
error_list ipv4SetHostAddrEx(NetInterface *interface, uint_t index, Ipv4Addr addr)
{
   Ipv4AddrEntry *entry;
...
error_list ipv4GetHostAddr(NetInterface *interface, Ipv4Addr *addr)
{
...
error_list ipv4GetHostAddrEx(NetInterface *interface, uint_t index, Ipv4Addr *addr)
{
   Ipv4AddrEntry *entry;
...
error_list ipv4SetSubnetMask(NetInterface *interface, Ipv4Addr mask)
{
   //Set subnet mask
...
error_list ipv4SetSubnetMaskEx(NetInterface *interface, uint_t index, Ipv4Addr mask)
{
   //Check parameters
   if(interface == NULL)
      return ERROR_INVALID_PARAMETER;
...
error_list ipv4GetSubnetMask(NetInterface *interface, Ipv4Addr *mask)
{
   //Get subnet mask
...
error_list ipv4GetSubnetMaskEx(NetInterface *interface, uint_t index, Ipv4Addr *mask)
{
   //Check parameters
...
error_list ipv4SetDefaultGateway(NetInterface *interface, Ipv4Addr addr)
{
   //Set default gateway
...
error_list ipv4SetDefaultGatewayEx(NetInterface *interface, uint_t index,
   Ipv4Addr addr)
{
   //Check parameters
   if(interface == NULL)
...
error_list ipv4GetDefaultGateway(NetInterface *interface, Ipv4Addr *addr)
{
   //Get default gateway
...
error_list ipv4GetDefaultGatewayEx(NetInterface *interface, uint_t index,
   Ipv4Addr *addr)
{
   //Check parameters
   if(interface == NULL || addr == NULL)
...
error_list ipv4SetDnsServer(NetInterface *interface, uint_t index, Ipv4Addr addr)
{
   //Check parameters
   if(interface == NULL)
      return ERROR_INVALID_PARAMETER;
...
error_list ipv4GetDnsServer(NetInterface *interface, uint_t index, Ipv4Addr *addr)
{
   //Check parameters
   if(interface == NULL || addr == NULL)
      return ERROR_INVALID_PARAMETER;
...
error_list ipv4SendDatagram(NetInterface *interface, Ipv4PseudoHeader *pseudoHeader,
...
error_list ipv4SendPacket(NetInterface *interface, Ipv4PseudoHeader *pseudoHeader,
...
error_list ipv4JoinMulticastGroup(NetInterface *interface, Ipv4Addr groupAddr)
{
   error_list error;
   uint_t i;
...
error_list ipv4LeaveMulticastGroup(NetInterface *interface, Ipv4Addr groupAddr)
{
   uint_t i;
   Ipv4FilterEntry *entry;
#if (ETH_SUPPORT == ENABLED)
...
error_list ipv4StringToAddr(const char_t *str, Ipv4Addr *ipAddr)
{
   error_list error;
   int_t i = 0;
   int_t value = -1;
