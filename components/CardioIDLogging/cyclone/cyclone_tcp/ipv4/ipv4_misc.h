...
error_list ipv4AddRouterAlertOption(NetBuffer *buffer, size_t *offset);

error_list ipv4CheckSourceAddr(NetInterface *interface, Ipv4Addr ipAddr);
error_list ipv4CheckDestAddr(NetInterface *interface, Ipv4Addr ipAddr);

error_list ipv4SelectSourceAddr(NetInterface **interface,
   Ipv4Addr destAddr, Ipv4Addr *srcAddr);

error_list ipv4SelectDefaultGateway(NetInterface *interface, Ipv4Addr srcAddr,
...
error_list ipv4GetBroadcastAddr(NetInterface *interface, Ipv4Addr *addr);
error_list ipv4MapMulticastAddrToMac(Ipv4Addr ipAddr, MacAddr *macAddr);
...
void ipv4UpdateErrorStats(NetInterface *interface, error_list error);
