...
error_list ipv4InitRouting(void);
error_list ipv4EnableRouting(NetInterface *interface, bool_t enable);

error_list ipv4AddRoute(Ipv4Addr networkDest, Ipv4Addr networkMask,
   NetInterface *interface, Ipv4Addr nextHop, uint_t metric);

error_list ipv4DeleteRoute(Ipv4Addr networkDest, Ipv4Addr networkMask);
error_list ipv4DeleteAllRoutes(void);

error_list ipv4ForwardPacket(NetInterface *srcInterface, const NetBuffer *ipPacket,
