...
error_list icmpv6EnableEchoRequest(NetInterface *interface, bool_t enable)
{
   //Check parameters
   if(interface == NULL)
...
error_list icmpv6EnableMulticastEchoRequest(NetInterface *interface,
   bool_t enable)
{
   //Check parameters
   if(interface == NULL)
...
error_list icmpv6SendErrorMessage(NetInterface *interface, uint8_t type,
