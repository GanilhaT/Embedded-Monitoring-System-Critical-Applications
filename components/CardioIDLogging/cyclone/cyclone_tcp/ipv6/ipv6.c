...
error_list ipv6Init(NetInterface *interface)
{
   Ipv6Context *context;
...
error_list ipv6SetMtu(NetInterface *interface, size_t mtu)
{
   error_list error;
   NetInterface *physicalInterface;
...
error_list ipv6GetMtu(NetInterface *interface, size_t *mtu)
{
   //Check parameters
...
error_list ipv6SetLinkLocalAddr(NetInterface *interface, const Ipv6Addr *addr)
{
   error_list error;
...
error_list ipv6GetLinkLocalAddr(NetInterface *interface, Ipv6Addr *addr)
{
   Ipv6AddrEntry *entry;
...
error_list ipv6SetGlobalAddr(NetInterface *interface, uint_t index, const Ipv6Addr *addr)
{
   error_list error;
...
error_list ipv6GetGlobalAddr(NetInterface *interface, uint_t index, Ipv6Addr *addr)
{
   Ipv6AddrEntry *entry;
...
error_list ipv6SetAnycastAddr(NetInterface *interface, uint_t index, const Ipv6Addr *addr)
{
   error_list error;
   NetInterface *physicalInterface;
...
error_list ipv6GetAnycastAddr(NetInterface *interface, uint_t index, Ipv6Addr *addr)
{
   //Check parameters
   if(interface == NULL || addr == NULL)
      return ERROR_INVALID_PARAMETER;
...
error_list ipv6SetPrefix(NetInterface *interface,
...
error_list ipv6GetPrefix(NetInterface *interface,
...
error_list ipv6SetDefaultRouter(NetInterface *interface, uint_t index, const Ipv6Addr *addr)
{
...
error_list ipv6GetDefaultRouter(NetInterface *interface, uint_t index, Ipv6Addr *addr)
{
   Ipv6RouterEntry *entry;
...
error_list ipv6SetDnsServer(NetInterface *interface, uint_t index, const Ipv6Addr *addr)
{
   //Check parameters
   if(interface == NULL || addr == NULL)
      return ERROR_INVALID_PARAMETER;
...
error_list ipv6GetDnsServer(NetInterface *interface, uint_t index, Ipv6Addr *addr)
{
   //Check parameters
   if(interface == NULL || addr == NULL)
      return ERROR_INVALID_PARAMETER;
...
error_list ipv6ParseHopByHopOptHeader(NetInterface *interface, const NetBuffer *ipPacket,
...
error_list ipv6ParseDestOptHeader(NetInterface *interface, const NetBuffer *ipPacket,
   size_t ipPacketOffset, size_t *headerOffset, size_t *nextHeaderOffset)
{
   error_list error;
   size_t n;
...
error_list ipv6ParseRoutingHeader(NetInterface *interface, const NetBuffer *ipPacket,
   size_t ipPacketOffset, size_t *headerOffset, size_t *nextHeaderOffset)
{
   size_t n;
   size_t length;
...
error_list ipv6ParseAhHeader(NetInterface *interface, const NetBuffer *ipPacket,
   size_t ipPacketOffset, size_t *headerOffset, size_t *nextHeaderOffset)
{
   //Debug message
...
error_list ipv6ParseEspHeader(NetInterface *interface, const NetBuffer *ipPacket,
   size_t ipPacketOffset, size_t *headerOffset, size_t *nextHeaderOffset)
{
   //Debug message
...
error_list ipv6ParseOptions(NetInterface *interface, const NetBuffer *ipPacket,
...
error_list ipv6SendDatagram(NetInterface *interface, Ipv6PseudoHeader *pseudoHeader,
...
error_list ipv6SendPacket(NetInterface *interface, Ipv6PseudoHeader *pseudoHeader,
...
error_list ipv6JoinMulticastGroup(NetInterface *interface, const Ipv6Addr *groupAddr)
{
   error_list error;
   uint_t i;
...
error_list ipv6LeaveMulticastGroup(NetInterface *interface, const Ipv6Addr *groupAddr)
{
   uint_t i;
   Ipv6FilterEntry *entry;
#if (ETH_SUPPORT == ENABLED)
...
error_list ipv6StringToAddr(const char_t *str, Ipv6Addr *ipAddr)
{
   error_list error;
   int_t i = 0;
   int_t j = -1;
