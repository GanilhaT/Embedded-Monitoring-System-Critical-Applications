...
error_list ipv6SetAddr(NetInterface *interface, uint_t index,
...
error_list ipv6CheckSourceAddr(NetInterface *interface, const Ipv6Addr *ipAddr);
error_list ipv6CheckDestAddr(NetInterface *interface, const Ipv6Addr *ipAddr);

error_list ipv6SelectSourceAddr(NetInterface **interface,
...
error_list ipv6ComputeSolicitedNodeAddr(const Ipv6Addr *ipAddr,
   Ipv6Addr *solicitedNodeAddr);

error_list ipv6MapMulticastAddrToMac(const Ipv6Addr *ipAddr, MacAddr *macAddr);
