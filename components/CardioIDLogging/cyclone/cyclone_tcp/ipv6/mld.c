...
error_list mldInit(NetInterface *interface)
{
...
error_list mldStartListening(NetInterface *interface, Ipv6FilterEntry *entry)
{
...
error_list mldStopListening(NetInterface *interface, Ipv6FilterEntry *entry)
{
   //Check link state
   if(interface->linkState)
   {
...
error_list mldSendListenerReport(NetInterface *interface, Ipv6Addr *ipAddr)
{
   error_list error;
   size_t offset;
   MldMessage *message;
...
error_list mldSendListenerDone(NetInterface *interface, Ipv6Addr *ipAddr)
{
   error_list error;
   size_t offset;
   MldMessage *message;
