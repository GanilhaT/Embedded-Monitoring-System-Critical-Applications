...
error_list ndpInit(NetInterface *interface)
{
   NdpContext *context;
...
error_list ndpAddStaticEntry(NetInterface *interface, const Ipv6Addr *ipAddr,
...
error_list ndpRemoveStaticEntry(NetInterface *interface, const Ipv6Addr *ipAddr)
{
   error_list error;
   NdpNeighborCacheEntry *entry;
...
error_list ndpResolve(NetInterface *interface, const Ipv6Addr *ipAddr,
   MacAddr *macAddr)
{
   error_list error;
   NdpNeighborCacheEntry *entry;
...
error_list ndpEnqueuePacket(NetInterface *srcInterface,
...
error_list ndpSendRouterSol(NetInterface *interface)
{
   error_list error;
   size_t offset;
   size_t length;
...
error_list ndpSendNeighborSol(NetInterface *interface,
...
error_list ndpSendNeighborAdv(NetInterface *interface,
...
error_list ndpSendRedirect(NetInterface *interface, const Ipv6Addr *targetAddr,
