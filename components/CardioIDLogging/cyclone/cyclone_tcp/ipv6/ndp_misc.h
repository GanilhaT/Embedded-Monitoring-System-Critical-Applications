...
error_list ndpSelectDefaultRouter(NetInterface *interface,
...
error_list ndpSelectNextHop(NetInterface *interface, const Ipv6Addr *destAddr,
...
error_list ndpCheckOptions(const uint8_t *options, size_t length);
