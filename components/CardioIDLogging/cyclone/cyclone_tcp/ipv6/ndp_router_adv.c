...
error_list ndpRouterAdvInit(NdpRouterAdvContext *context,
...
error_list ndpRouterAdvStart(NdpRouterAdvContext *context)
{
   error_list error;
   NetInterface *interface;
...
error_list ndpRouterAdvStop(NdpRouterAdvContext *context)
{
   error_list error;
   NetInterface *interface;
