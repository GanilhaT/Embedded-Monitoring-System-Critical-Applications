...
error_list slaacInit(SlaacContext *context, const SlaacSettings *settings);

error_list slaacStart(SlaacContext *context);
error_list slaacStop(SlaacContext *context);
