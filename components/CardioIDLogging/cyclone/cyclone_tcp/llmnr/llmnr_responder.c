...
error_list llmnrResponderInit(NetInterface *interface)
{
   error_list error;
...
error_list llmnrSendResponse(NetInterface *interface, const IpAddr *destIpAddr,
...
error_list llmnrFormatIpv4AddrRecord(NetInterface *interface,
...
error_list llmnrFormatIpv6AddrRecord(NetInterface *interface,
