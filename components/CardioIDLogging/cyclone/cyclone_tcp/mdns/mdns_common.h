...
error_list mdnsInit(NetInterface *interface);
...
error_list mdnsCreateMessage(MdnsMessage *message, bool_t queryResponse);
void mdnsDeleteMessage(MdnsMessage *message);

error_list mdnsSendMessage(NetInterface *interface, const MdnsMessage *message,
