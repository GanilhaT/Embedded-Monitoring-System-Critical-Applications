...
error_list mdnsResponderInit(MdnsResponderContext *context,
   const MdnsResponderSettings *settings);

error_list mdnsResponderStart(MdnsResponderContext *context);
error_list mdnsResponderStop(MdnsResponderContext *context);
MdnsState mdnsResponderGetState(MdnsResponderContext *context);

error_list mdnsResponderSetHostname(MdnsResponderContext *context,
   const char_t *hostname);

error_list mdnsResponderStartProbing(MdnsResponderContext *context);
