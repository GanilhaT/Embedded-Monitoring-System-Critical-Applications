...
error_list mdnsResponderSendProbe(MdnsResponderContext *context)
{
   error_list error;
   NetInterface *interface;
...
error_list mdnsResponderSendAnnouncement(MdnsResponderContext *context)
{
   error_list error;
   NetInterface *interface;
   MdnsMessage message;
...
error_list mdnsResponderSendGoodbye(MdnsResponderContext *context)
{
   error_list error;
   NetInterface *interface;
   MdnsMessage message;
...
error_list mdnsResponderParseQuestion(NetInterface *interface,
...
error_list mdnsResponderGenerateIpv4AddrRecords(MdnsResponderContext *context,
...
error_list mdnsResponderGenerateIpv6AddrRecords(MdnsResponderContext *context,
   MdnsMessage *message, bool_t cacheFlush, uint32_t ttl)
{
#if (IPV6_SUPPORT == ENABLED)
   error_list error;
...
error_list mdnsResponderGenerateIpv4PtrRecords(MdnsResponderContext *context,
   MdnsMessage *message, bool_t cacheFlush, uint32_t ttl)
{
#if (IPV4_SUPPORT == ENABLED)
   error_list error;
...
error_list mdnsResponderGenerateIpv6PtrRecords(MdnsResponderContext *context,
   MdnsMessage *message, bool_t cacheFlush, uint32_t ttl)
{
#if (IPV6_SUPPORT == ENABLED)
   error_list error;
...
error_list mdnsResponderFormatIpv4AddrRecord(MdnsResponderContext *context,
...
error_list mdnsResponderFormatIpv6AddrRecord(MdnsResponderContext *context,
...
error_list mdnsResponderFormatIpv4PtrRecord(MdnsResponderContext *context,
...
error_list mdnsResponderFormatIpv6PtrRecord(MdnsResponderContext *context,
   MdnsMessage *message, const char_t *reverseName, bool_t cacheFlush,
   uint32_t ttl)
{
   size_t n;
...
error_list mdnsResponderFormatNsecRecord(MdnsResponderContext *context,
   MdnsMessage *message, bool_t cacheFlush, uint32_t ttl)
{
   size_t n;
   size_t offset;
