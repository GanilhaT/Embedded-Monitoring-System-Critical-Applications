...
error_list chapStartAuth(PppContext *context);
error_list chapAbortAuth(PppContext *context);
...
error_list chapProcessChallenge(PppContext *context,
   const ChapChallengePacket *challengePacket, size_t length);

error_list chapProcessResponse(PppContext *context,
   const ChapResponsePacket *responsePacket, size_t length);

error_list chapProcessSuccess(PppContext *context,
   const ChapSuccessPacket *successPacket, size_t length);

error_list chapProcessFailure(PppContext *context,
   const ChapFailurePacket *failurePacket, size_t length);

error_list chapSendChallenge(PppContext *context);
error_list chapSendResponse(PppContext *context, const uint8_t *value);
error_list chapSendSuccess(PppContext *context);
error_list chapSendFailure(PppContext *context);
