...
//IPCP FSM events
error_list ipcpOpen(PppContext *context);
error_list ipcpClose(PppContext *context);

void ipcpTick(PppContext *context);

void ipcpProcessPacket(PppContext *context, const PppPacket *packet, size_t length);

error_list ipcpProcessConfigureReq(PppContext *context,
   const PppConfigurePacket *configureReqPacket);

error_list ipcpProcessConfigureAck(PppContext *context,
   const PppConfigurePacket *configureAckPacket);

error_list ipcpProcessConfigureNak(PppContext *context,
   const PppConfigurePacket *configureNakPacket);

error_list ipcpProcessConfigureReject(PppContext *context,
   const PppConfigurePacket *configureRejPacket);

error_list ipcpProcessTerminateReq(PppContext *context,
   const PppTerminatePacket *terminateReqPacket);

error_list ipcpProcessTerminateAck(PppContext *context,
   const PppTerminatePacket *terminateAckPacket);

error_list ipcpProcessCodeRej(PppContext *context,
   const PppCodeRejPacket *codeRejPacket);

error_list ipcpProcessUnknownCode(PppContext *context,
...
error_list ipcpSendConfigureReq(PppContext *context);

error_list ipcpSendConfigureAck(PppContext *context,
   const PppConfigurePacket *configureReqPacket);

error_list ipcpSendConfigureNak(PppContext *context,
   const PppConfigurePacket *configureReqPacket);

error_list ipcpSendConfigureRej(PppContext *context,
   const PppConfigurePacket *configureReqPacket);

error_list ipcpSendTerminateReq(PppContext *context);

error_list ipcpSendTerminateAck(PppContext *context,
   const PppTerminatePacket *terminateReqPacket);

error_list ipcpSendCodeRej(PppContext *context, const PppPacket *packet);

//IPCP options checking
error_list ipcpParseOption(PppContext *context, PppOption *option,
   size_t inPacketLen, PppConfigurePacket *outPacket);

error_list ipcpParseIpAddressOption(PppContext *context,
