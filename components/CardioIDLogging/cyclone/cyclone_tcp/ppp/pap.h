...
error_list papStartAuth(PppContext *context);
error_list papAbortAuth(PppContext *context);
...
error_list papProcessAuthReq(PppContext *context,
   const PapAuthReqPacket *authReqPacket, size_t length);

error_list papProcessAuthAck(PppContext *context,
   const PapAuthAckPacket *authAckPacket, size_t length);

error_list papProcessAuthNak(PppContext *context,
   const PapAuthNakPacket *authNakPacket, size_t length);

error_list papSendAuthReq(PppContext *context);
error_list papSendAuthAck(PppContext *context, uint8_t identifier);
error_list papSendAuthNak(PppContext *context, uint8_t identifier);
