...
typedef error_list (*PppSendConfigureReq)(PppContext *context);
...
typedef error_list (*PppSendConfigureAck)(PppContext *context,
...
typedef error_list (*PppSendConfigureNak)(PppContext *context,
   const PppConfigurePacket *configureReqPacket);
...
typedef error_list (*PppSendConfigureRej)(PppContext *context,
   const PppConfigurePacket *configureReqPacket);
...
typedef error_list (*PppSendTerminateReq)(PppContext *context);
...
typedef error_list (*PppSendTerminateAck)(PppContext *context,
...
typedef error_list (*PppSendCodeRej)(PppContext *context,
...
typedef error_list (*PppSendEchoRep)(PppContext *context,
