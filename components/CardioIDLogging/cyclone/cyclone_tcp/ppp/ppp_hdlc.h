...
error_list pppHdlcDriverInit(NetInterface *interface);
...
error_list pppHdlcDriverSendPacket(NetInterface *interface,
   const NetBuffer *buffer, size_t offset, NetTxAncillary *ancillary);

error_list pppHdlcDriverReceivePacket(NetInterface *interface);

error_list pppHdlcDriverUpdateMacAddrFilter(NetInterface *interface);

error_list pppHdlcDriverSendAtCommand(NetInterface *interface, const char_t *data);

error_list pppHdlcDriverReceiveAtCommand(NetInterface *interface, char_t *data,
   size_t size);

error_list pppHdlcDriverPurgeTxBuffer(PppContext *context);
error_list pppHdlcDriverPurgeRxBuffer(PppContext *context);
